...
> **元信息**：日期 2026-08-05 · 状态：完成 · 目标：Soft UI 风格全面落地（令牌 + 组件 + 布局密度 + 动效）· 关联规范：AGENTS.md、plan-document.md
...
- [x] **Step 3: 删除 dark 媒体查询与 .dark 块（本项目不做深色模式）**
...
- [x] **Step 4: body 字体与 reduced-motion**
...
- [x] **Step 2: conversation-list.tsx 改造**
...
- [x] **Step 1: message-bubble.tsx 改造**
...
- [x] **Step 2: tool-progress-card.tsx 改造**
